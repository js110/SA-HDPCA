...
def main():
    ...
    for ds in datasets:
        ...
        for eps_tot in eps_list:
            # compute and store schedules for plotting
            ...
            for seed in seeds:
                ...
                for method in methods:
                    ...
                    if method_key == "SA-HDPCA":
                        ...
                        # Only run ablations on HAR eps=0.8 to control runtime
                    ...
                    # metrics on original preprocessed space using labels
