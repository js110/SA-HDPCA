...
# DBDP (SSRN 4798792) Algorithm 1 mapping:
# Lines 2-7 noisy density checks -> _label_clusters (noisy_density via Laplace)
# Lines 8-17 cluster expansion with eps2/(2k) -> BFS expansion in _label_clusters
# eps radius is chosen by quantile heuristic (minimal faithful proxy for eps search).
...
def fit_predict(
    ...
    for eps_radius in eps_candidates:
        ...
        # compute simple score: prioritize non-empty cluster count then SSE
    ...
    # assign labels for full set if subsampled
